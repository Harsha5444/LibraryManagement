...
namespace LibraryManagement.UI
{
    ...
    {
        private readonly MemberService _mBLL = new MemberService();

        public (LoginResult result, string message, bool isAdmin) PerformLogin(string email, string password)
        {
            (LoginResult result, string message) = _mBLL.ProcessLogin(email, password);
        ...
        public void Register()
        {
            ...
            (bool isSuccess, string message) = _mBLL.RegisterUser(name, address, phone, email, password, isAdmin);
            Console.WriteLine(message);
        }
